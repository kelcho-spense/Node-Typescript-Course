...
//     const result = await request.query('INSERT INTO todos (title) VALUES (@title); SELECT SCOPE_IDENTITY() as id;');
...
//     const result = await request.query('SELECT * FROM todos WHERE id = @id');
